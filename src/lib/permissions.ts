...
export enum Permission {
  ...
  DATA_COLLECTION_DELETE = 'data_collection:delete',
  DATA_COLLECTION_MANAGE = 'data_collection:manage',
  DATA_COLLECTION_IMPORT = 'data_collection:import',
  DATA_COLLECTION_EXPORT = 'data_collection:export',
...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  [UserRole.CITY_ADMIN]: [
    ...
    Permission.DATA_COLLECTION_DELETE,
    Permission.DATA_COLLECTION_MANAGE,
    Permission.DATA_COLLECTION_IMPORT,
    Permission.DATA_COLLECTION_EXPORT,
...
export function checkPermission(userRole: UserRole, resource: string, action: string): boolean {
  ...
  if (!permission) {
    ...
    const mappings: Record<string, Permission> = {
      ...
      'data_collection_read': Permission.DATA_COLLECTION_VIEW,
      'data_collection_create': Permission.DATA_COLLECTION_CREATE,
      'data_collection_update': Permission.DATA_COLLECTION_EDIT,
      'data_collection_delete': Permission.DATA_COLLECTION_DELETE,
      'data_collection_manage': Permission.DATA_COLLECTION_MANAGE,
      'data_collection_import': Permission.DATA_COLLECTION_IMPORT,
      'data_collection_export': Permission.DATA_COLLECTION_EXPORT,
    }
